...
foreach ($hero_elements as $index => $single_hero_element) {
    ...
    if ($single_hero_element['id'] == 'custom_thumbnail' && $single_hero_element['enabled'] && has_post_thumbnail( tainacan_get_collection_id() )) {
    ...
    } else if ($single_hero_element['id'] == 'custom_description' && $single_hero_element['enabled'] && tainacan_get_the_collection_description()) {
        ...
        $elements[] = '<div class="' . $description_class . '">' . tainacan_get_the_collection_description() . '</div>';
